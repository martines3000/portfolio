  ...
  return (
    <>
      <nav
        ...
        } z-30 flex w-2/3 flex-none flex-col overflow-y-auto border-r-2 border-sky-800 bg-gray-300 transition-transform duration-200 ease-in-out dark:bg-black sm:w-1/3 lg:relative lg:w-44 lg:translate-x-0`}
      >
